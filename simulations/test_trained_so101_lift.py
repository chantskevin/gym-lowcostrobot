...
parser = argparse.ArgumentParser(description='Test a trained SO101 lift cube model')
...
models_dir = "logs/so101_lift_cube/models"
model_path = os.path.join(models_dir, "so101_lift_cube_final")
